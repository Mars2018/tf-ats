...
#         default_config = 'config/model.conf'
    ...
    p.add("-t", "--model_type", type=str, default='regp', help="Model type (reg|regp|breg|bregp) (default=regp)")
    ...
    p.add("--dropout", type=float, default=0.5, help="The dropout probability. To disable, give a negative number (default=0.5)")
